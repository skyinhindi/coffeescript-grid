...
const TransferModal = ({ showModal, setShowModal, tokenId }) => {
  ...
  return (
    ...
    >
      ...
      {!transferred ? (
        <div className="notTransfered">
          <div
            className={
              isActive
                ? "transfer-ownership-inputDiv"
                : "transfer-ownership-inputDiv-ns"
            }
          >
            <input
              onFocus={() => {
              ...
              type="text"
              placeholder={isActive ? "" : "Recipient Address"}
        ...
        <div className="transferred-text">
          Successfully transferred. You can close this window
        </div>
      )}
    </Modal>
  );
